...
Tffile = matfile('~/matlab/data/fineData/systemSize=512x512/correlated_binary/IsoSEcov/l=20_sigmafSq=1/volumeFraction=0.3/locond=1_hicond=100/BCcoeffs=[-5 3 0 0]/set1-samples=1024.mat');
