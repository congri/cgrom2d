function [out] = linPathParams(cond, pathLengths, fineData, domainc, domainf, param)
...
for i = 1:numel(pathLengths)
    L(i) = .5*linealPath(cond, pathLengths(i), 'x', 1, fineData, nElc, nElf)...
        + .5*linealPath(cond, pathLengths(i), 'y', 1, fineData, nElc, nElf);
end
